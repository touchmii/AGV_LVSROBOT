 ...
 *
 * STEP 1, define macro define related to the serial port opening based on the
 * serial port number such as    
 * #define BSP_USING_UART1
 *
 * STEP 2, according to the corresponding pin of serial port, define the related
 * serial port information macro such as     
 * #define BSP_UART1_TX_PIN     "PA9"
 * #define BSP_UART1_RX_PIN     "PA10"
 *
 * STEP 3, if you want using SERIAL DMA, you must open it in the RT-Thread
 * Settings. RT-Thread Setting -> Components -> Device Drivers -> Serial Device
 * Drivers -> Enable Serial DMA Mode
 *
 * STEP 4, according to serial port number to define serial port tx/rx DMA
 * function in the board.h file such as     
...
/** if you want to use i2c bus(soft simulate) you can use the following
 * instructions.
 *
 * STEP 1, open i2c driver framework(soft simulate) support in the RT-Thread
 * Settings file
 *
 * STEP 2, define macro related to the i2c bus such as     
 * #define BSP_USING_I2C1
 *
 * STEP 3, according to the corresponding pin of i2c port, modify the related
 * i2c port and pin information such as     @
 * define BSP_I2C1_SCL_PIN
 * GET_PIN(port, pin)   ->   GET_PIN(C, 11) 
 * #define BSP_I2C1_SDA_PIN
 * GET_PIN(port, pin)   ->   GET_PIN(C, 12)
 */
...
#define BSP_I2C3_SCL_PIN    GET_PIN(H, 7)
#define BSP_I2C3_SDA_PIN    GET_PIN(H, 8)
#endif
/*-------------------------- I2C CONFIG END --------------------------*/
 ...
 *
 * STEP 2, define macro related to the spi bus uch as     
 * #define BSP_USING_SPI1
 *
 * STEP 3, copy your spi init function from stm32xxxx_hal_msp.c generated by
 * stm32cubemx to the end of board.c file such as     
 * void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
 *
 * STEP 4, modify your stm32xxxx_hal_config.h file to support spi peripherals.
 * define macro related to the peripherals such as     
 ...
 *
 * STEP 2, define macro related to the qspi such as     
 ...
 *
 * STEP 4, modify your stm32xxxx_hal_config.h file to support qspi peripherals.
 * define macro related to the peripherals such as     
 ...
 *
 * STEP 3, copy your pwm timer init function from stm32xxxx_hal_msp.c generated
 * by stm32cubemx to the end if board.c file such as     
 * void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* htim_base)  and 
 * void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
 *
 * STEP 4, modify your stm32xxxx_hal_config.h file to support pwm peripherals.
 * define macro related to the peripherals such as     
 ...
 *
 * STEP 2, modify your stm32xxxx_hal_config.h file to support wdt peripherals.
 * define macro related to the peripherals such as     
 ...
 *
 * STEP 3, copy your hardwire timer init function from stm32xxxx_hal_msp.c
 * generated by stm32cubemx to the end of board.c file such as     
 * void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* htim_base)
 *
 * STEP 4, modify your stm32xxxx_hal_config.h file to support hardwere timer
 * peripherals. define macro related to the peripherals such as     
 * #define HAL_TIM_MODULE_ENABLED
 *
 */
 ...
 *
 * STEP 1, open rtc driver framework(hardware) support in the RT-Thread Settings
 * file
 *
 * STEP 2, define macro related to the rtc
 *                 such as    BSP_USING_ONCHIP_RTC
 *
 * STEP 3, modify your stm32xxxx_hal_config.h file to support rtc peripherals.
 * define macro related to the peripherals such as     
 ...
 *
 * STEP 3, copy your sdio init function from stm32xxxx_hal_msp.c generated by
 * stm32cubemx to the end of board.c file such as     
 * void HAL_SD_MspInit(SD_HandleTypeDef* hsd)
 *
 * STEP 4, modify your stm32xxxx_hal_config.h file to support sdio peripherals.
 * define macro related to the peripherals such as     
 ...
 *
 * STEP 2, copy your eth init function from stm32xxxx_hal_msp.c generated by
 * stm32cubemx to the end if board.c file such as     
 * void HAL_ETH_MspInit(ETH_HandleTypeDef* heth)
 *
 * STEP 3, modify your stm32xxxx_hal_config.h file to support eth peripherals.
 * define macro related to the peripherals such as    
 ...
 *
 * STEP 3, copy your usb host init function from stm32xxxx_hal_msp.c generated
 * by stm32cubemx to the end of board.c file such as     
 * void HAL_HCD_MspInit(HCD_HandleTypeDef* hhcd)
 *
 * STEP 4, config your usb peripheral clock in SystemClock_Config() generated by
 * STM32CubeMX and replace this function in board.c
 *
 * STEP 5, modify your stm32xxxx_hal_config.h file to support usb host
 * peripherals. define macro related to the peripherals such as     #define
 ...
 *
 * STEP 1, open usb device driver framework support in the RT-Thread Settings
 * file
 *
 * STEP 2 define macro related to the usb device
 * such as    BSP_USING_USBDEVICE
 *
 * STEP 3, copy your usb device init function from stm32xxxx_hal_msp.c generated
 * by stm32cubemx to the end of board.c file such as    
 ...
 * STM32CubeMX and replace this function in board.c
 *
 * STEP 5, modify your stm32xxxx_hal_config.h file to support usb device
 * peripherals. define macro related to the peripherals such as    
 ...
 *
 * STEP 2, modify your stm32xxxx_hal_config.h file to support on chip flash
 * peripherals. define macro related to the peripherals such as     
